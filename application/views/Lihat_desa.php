              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <form class="form-horizontal" action="desa/proses_tambah_desa" method="post">
                    ...
                    <div class="form-group form-material ">
                      <label class="col-lg-4 col-sm-4 control-label">Kecamatan
                        <span class="required">*</span>
                      </label>
                      <div class="col-lg-8 col-sm-8">
              ...
              <?php
               ...
               ?>
                <tr>
                  ...
                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."ubah_kecamatan?id=$data_desa->id_desa' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
                    \" title='Hapus'><button type='button' class='btn btn-warning'>Edit</button></a>
                    </td>";
                  ?>
                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."Kecamatan/proses_hapus_kecamatan?id=$data_desa->id_desa' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
