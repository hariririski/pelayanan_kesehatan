          ...
          <div class="row row-lg">
            ...
            <div class="col-sm-6 col-md-6">
              ...
              <div class="example-wrap">
                <h4 class="example-title">Poli</h4>

                <div class="example">
                  <form class="form-horizontal" action="poli/proses_tambah_poli" method="post">
                    <div class="form-group form-material">
                      <label class="col-sm-4 control-label">Nama Poli</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_poli" required placeholder="Nama Poli" autocomplete="off" required>
                      </div>
                    </div>
                    <div class="form-group form-material">
