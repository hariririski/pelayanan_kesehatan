              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="desa" value="<?php echo $data_jalan_rusak->desa?>"  placeholder="Desa" required="" >
                      </div>
                    </div>
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="keterangan" value="<?php echo $data_jalan_rusak->keterangan?>"  placeholder="Keterangan" >
                    </div>
                  </div>
                ...
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="luas_jalan" value="<?php echo $data_jalan_rusak->luas_jalan?>"  placeholder="Luas Jalan Rusak" required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <div class="input-group input-group-file">
                        <input type="text" class="form-control" value="<?php echo $data_jalan_rusak->photo?>" >
