                ...
                <div class="example">
                  <form class="form-horizontal" action="kabupaten/proses_tambah_kabupaten" method="post">
                    <div class="form-group form-material">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_kabupaten" required placeholder="Nama Kabupaten" autocomplete="off" required>
                      </div>
                    </div>
                    <div class="form-group form-material">
        ...
        <div class="panel-body">
          <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
            ...
            <tbody>
              <?php
                 $i=0;
                 foreach($lihat as $data_kabupaten){
                 $i++;
               ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  ...
                  ?>
                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."Kabupaten/proses_hapus_kabupaten?id=$data_kabupaten->id_kabupaten' onclick=\"return confirm('Apakah Anda Yakin Menghapus ?')
