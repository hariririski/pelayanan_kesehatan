              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data_jalan->kode_ruas?>" readonly name="kode_ruas" placeholder="Kode Ruas" required=""  >
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" value="<?php echo $data_jalan->no_ruas?>" readonly name="no_ruas" placeholder="No Ruas" required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                    <input type="text" class="form-control" name="status" value="<?php echo $data_jalan->status?>" readonly  placeholder="Status" required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="nama_jalan" value="<?php echo $data_jalan->nama_jalan?>" readonly  placeholder="Ruas Jalan" required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-9 col-sm-9">
                      <input type="text" class="form-control" name="panjang_km"  value="<?php echo $data_jalan->panjang_km?>" readonly  placeholder="Panjang KM" required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-3 col-sm-9">
                      <input type="text" class="form-control" name="dari" placeholder="Dari"  value="<?php echo $data_jalan->dari?>" readonly  required="" >
                    </div>
                    ...
                    <div class=" col-lg-4 col-sm-9">
                      <input type="text" class="form-control" name="ke" placeholder="Ke"  value="<?php echo $data_jalan->ke?>" readonly  required="" >
                    </div>
                  </div>
                  <div class="form-group form-material ">
                ...
                <div class="col-lg-6 form-horizontal">
                    ...
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="keterangan" placeholder="Keterangan"  value="<?php echo $data_jalan->keterangan?>" readonly  required="" >
                      </div>
                    </div>
                    ...
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="baik" placeholder="Luas Jalan Kondisi Baik"  value="<?php echo $data_jalan->baik?>" readonly  required="" >
                    ...
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="sedang" placeholder="Luas Jalan Kondisi Sedang"  value="<?php echo $data_jalan->rusak_sedang?>" readonly  required="" >
                      </div>
                    </div>
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="rusak_ringan" placeholder="Luas Jalan Kondisi Rusak Ringan"  value="<?php echo $data_jalan->rusak_ringan?>" readonly  required="" >
                      </div>
                    </div>
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="rusak_berat" placeholder="Luas Jalan Kondisi Rusak Ringan" required=""  value="<?php echo $data_jalan->rusak_berat?>" readonly  >
                      </div>
                    </div>
                    <div class="form-group form-material ">
                      ...
                      <div class=" col-lg-9 col-sm-9">
                        <input type="text" class="form-control" name="belum_tembus" placeholder="Luas Jalan Kondisi Belum Tembus"  value="<?php echo $data_jalan->belum_tembus?>" readonly  required="" >
                      </div>
                    </div>
                    <div class="form-group form-material ">
