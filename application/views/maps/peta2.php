...
<html lang="en">
  <head>
    ...
    <link href="<?php echo site_url(); ?>assets/maps/css/theme.css" rel="stylesheet">
    <link href="<?php echo site_url(); ?>assets/maps/css/bootstrap-reset.css" rel="stylesheet">
    <!--external css-->
    <link href="<?php echo site_url(); ?>assets/maps/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo site_url(); ?>assets/maps/css/flexslider.css"/>
    <link href="<?php echo site_url(); ?>assets/maps/assets/bxslider/jquery.bxslider.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo site_url(); ?>assets/maps/css/animate.css">
    <link href='http://fonts.googleapis.com/css?family=Lato' rel='stylesheet' type='text/css'>


      <!-- Custom styles for this template -->
    <link href="<?php echo site_url(); ?>assets/maps/css/style.css" rel="stylesheet">
    <link href="<?php echo site_url(); ?>assets/maps/css/style-responsive.css" rel="stylesheet" />
   ...
   */
    ...
    * @constant
    */
   MarkerClusterer.IMAGE_PATH = "<?php echo site_url(); ?>assets/maps/cluster/images/m";
...
function pelkes(checkbox)
{
  ...
  <!-- js placed at the end of the document so the pages load faster -->
    <script src="<?php echo site_url(); ?>assets/maps/js/jquery.js"></script>
    <script src="<?php echo site_url(); ?>assets/maps/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?php echo site_url(); ?>assets/maps/js/hover-dropdown.js"></script>
    <script defer src="<?php echo site_url(); ?>assets/maps/js/jquery.flexslider.js"></script>
    <script type="<?php echo site_url(); ?>assets/maps/text/javascript" src="assets/bxslider/jquery.bxslider.js"></script>

    <script src="<?php echo site_url(); ?>assets/maps/js/jquery.easing.min.js"></script>
    <script src="<?php echo site_url(); ?>assets/maps/js/link-hover.js"></script>


     <!--common script for all pages-->
    <script src="<?php echo site_url(); ?>assets/maps/js/common-scripts.js"></script>


    <script src="<?php echo site_url(); ?>assets/maps/js/wow.min.js"></script>
    <script>
        wow = new WOW(
          {
