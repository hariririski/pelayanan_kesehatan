           ...
           <div class="row row-lg">
             <div class="col-lg-12">
               ...
               <div class="example-wrap">
                 ...
                 <div class="example-wrap row" id="demo">
...
?>
        ['<?php echo $pelkes->id_pelayanan_kesehatan ?>','title',<?php echo $pelkes->lat ?>,<?php echo $pelkes->lon ?>,'<?php echo $pelkes->id_kabupaten?>','<?php echo $pelkes->nama_jenis_pelayanan?>','<?php echo site_url();?>uploads/<?php echo $pelkes->icon ?>'],
<?php }?>
