        ...
        <div class="panel-body">
          ...
          <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
            ...
            <tbody>
              <?php
                 $i=0;
                 foreach($lihat as $pelayanan_kesehatan){
                 $i++;
               ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $pelayanan_kesehatan->nama_pelayanan_kesehatan; ?></td>
                  <td><?php echo $pelayanan_kesehatan->nama_jenis_pelayanan; ?></td>
                  <td><?php echo $pelayanan_kesehatan->nama_kabupaten; ?></td>
                  <td><?php echo $pelayanan_kesehatan->nama_kecamatan; ?></td>
                  <td><?php echo $pelayanan_kesehatan->nama_desa; ?></td>

                  <?php
                  echo"<td class='center' width='10%'><a href='". site_url()."umum/detail?id=".$pelayanan_kesehatan->id_pelayanan_kesehatan."'>
