...
<?php echo $this->load->view('common/menu', '', TRUE);?>
  ...
  <div class="page animsition">
    <div class="page-header">
      ...
      <h1 class="page-title">Jenis Layer</h1>
    ...
    <div class="page-content">
                ...
                <div class="example">
                  <form class="form-horizontal" action="layer/proses_tambah_layer" method="post">
                    <div class="form-group form-material">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_layer" required placeholder="Nama Layer" autocomplete="off" required>
                      </div>
                    </div>
                    <div class="form-group form-material">
                      <label class="col-sm-4 control-label">URL Layer</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="url" required placeholder="Url Layer" autocomplete="off" required>
                      </div>
                    </div>
                    <div class="form-group form-material">
      ...
      <div class="panel">
        <header class="panel-heading">
          ...
          <h3 class="panel-title">Data Jenis Pelayanan</h3>
        </header>
