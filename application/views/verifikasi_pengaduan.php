...
<?php
   foreach($lihat as $pengaduan){
 ?>
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title"><?php echo $pengaduan->nama_jalan?></h1>
              ...
              <div class="row row-lg">
                <div class="col-lg-6 form-horizontal">
                    ...
                    <div class="form-group form-material ">
                        <label class="col-lg-3 col-sm-3 control-label">Tanggal
                          <span class="required">*</span>
                        </label>
                        <div class=" col-lg-9 col-sm-9">
                          <input type="text" class="form-control" name="no_ktp" value="<?php echo $pengaduan->tanggal_create?>" readonly placeholder="No KTP" required="" >
                        </div>
                      </div>
                    <div class="form-group form-material ">
                        ...
                        <div class=" col-lg-9 col-sm-9">
                          <input type="text" class="form-control" name="no_ktp" value="<?php echo $pengaduan->no_ktp_pelapor?>" readonly placeholder="No KTP" required="" >
                        </div>
                      </div>
                        <div class="form-group form-material ">
                          ...
                          <div class=" col-lg-9 col-sm-9">
                            <input type="text" class="form-control" name="nama"  value="<?php echo $pengaduan->nama_pelapor?>" readonly placeholder="Nama" required="" >
                          </div>
                        </div>
                        <div class="form-group form-material ">
                          ...
                          <div class=" col-lg-9 col-sm-9">
                            <input type="text" class="form-control" name="alamat" value="<?php echo $pengaduan->alamat_pelapor?>" readonly  placeholder="Alamat" required="" >
                          </div>
                        </div>
                        <div class="form-group form-material ">
                            ...
                            <div class=" col-lg-9 col-sm-9">
                              <input type="text" class="form-control" name="no_hp" placeholder="No HP"  value="<?php echo $pengaduan->no_hp_pelapor?>" readonly required="" >
                            </div>
                        </div>
                    ...
                    <div class="form-group form-material ">
                      ...
                      <div class="col-lg-9 col-sm-9">
                        <select class="form-control select2-hidden-accessible" name="id_kabupaten" required data-plugin="select2"  data-allow-clear="true" tabindex="-1" aria-hidden="true">
                          <option id="kabupaten" value="<?php echo $pengaduan->id_kabupaten?>"><?php echo $pengaduan->nama_kabupaten?></option>
                        <?php

                           foreach($kabupaten as $kabupaten){
                            if($pengaduan->id_kabupaten!=$kabupaten->id_kabupaten){
                         ?>
                    ...
                    <div class="form-group form-material ">
                      ...
                      <div class="col-lg-9 col-sm-9">
                        <select class="form-control select2-hidden-accessible" name="id_kecamatan" required data-plugin="select2"  data-allow-clear="true" tabindex="-1" aria-hidden="true">
                          <<option id="kecamatan" value="<?php echo $pengaduan->id_kecamatan?>"><?php echo $pengaduan->nama_kecamatan?></option>
                          <?php

                             foreach($kecamatan as $kecamatan){
                              if($pengaduan->id_kecamatan!=$kecamatan->id_kecamatan){
                           ?>
                ...
                <div class="col-lg-6 form-horizontal">
                  ...
                  <div class="form-group form-material ">
                    ...
                    <div class=" col-lg-12 col-sm-12">
                      ...
                      var latLng = new google.maps.LatLng(<?php echo $pengaduan->lat?>, <?php echo $pengaduan->lon?>);
                  ...
                  <div class="form-group form-material ">
                    ...
                    <center><img src="<?php echo site_url(); ?>uploads/<?php echo $pengaduan->photo?>" width="50%"><br>
                    </center>
                  </div>
