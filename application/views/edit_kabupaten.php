                ...
                <div class="example">
                  <form class="form-horizontal" action="kabupaten/proses_ubah_kabupaten/<?php echo $kabupaten->id_kabupaten?>" method="post">
                    <div class="form-group form-material">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_kabupaten" value="<?php echo $kabupaten->nama_kabupaten?>" required placeholder="Nama Kabupaten" autocomplete="off" required>
                      </div>
                    </div>
                    <div class="form-group form-material">
